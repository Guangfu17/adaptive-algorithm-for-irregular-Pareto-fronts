...
%   Example:
%
%       main('-algorithm',@AMAWV,'-problem',@DTLZ2,'-N',200,'-M',10)
%
%   runs AMAWV on 10-objective DTLZ2 with a population size of 200.
%
%       for i = 1 : 10
%           main('-algorithm',@AMAWV,'-problem',@DTLZ1,'-run',i,'-save',5)
%       end
%
%   runs AMAWV on DTLZ1 for 10 times, and each time saves 5 populations to
%   a file in /Data/AMAWV.
